...
urlpatterns = [
    ...
    path('user/updateheadpic/', setUserHeadPic), # 确保有这个路由
    path('intelligent/recommend/', intelligent_recommend),
    path('agent/news-qa/', news_qa),
    path('agent/init-vectors/', init_vectors),
    path('agent/vector-status/', vectorization_status),
