...
def parse_args():
    ...
    parser.add_argument('--layers', type=int, default=3,
                        help='Number of item graph conv layers') #1 
    parser.add_argument('--mess_dropout', nargs='?', default='[0.1, 0.1]',
                        help='Keep probability w.r.t. message dropout (i.e., 1-dropout_ratio) for each deep layer. 1: no dropout.')
    ...
    # kd
    parser.add_argument('--student_embed_size', type=int, default=32, help='Embedding size.')  # 16, 32,64        
    parser.add_argument('--student_lr', type=float, default=0.0001, help='Learning rate.')  #0.002 0.001, 0.00001 
    ...
    parser.add_argument('--feat_soft_token_rate', type=float, default=0.05, help='控制Prompt注入多模态特征的比例') # <--- 新增这一行
    ...
    # ---------------- 新增 MoE 结构参数 ----------------
    parser.add_argument('--num_experts', type=int, default=4, help='Total number of experts in MoE Prompt Layer') 
    parser.add_argument('--top_k', type=int, default=2, help='Number of active experts per token in MoE')
    parser.add_argument('--prompt_dropout', type=float, default=0.1, help='Dropout rate for MoE generated soft prompts') 
    # --------------------------------------------------
    return parser.parse_args()
